...
public class ProductCategoryService : IProductCategoryService
{
    ...
    public async Task<IEnumerable<Response.ProductCategoryResponse>> GetProductCategories()
    {
        var productCategories = _productCategoryRepository.FindAll().AsAsyncEnumerable();
        var result = _mapper.Map<IEnumerable<Response.ProductCategoryResponse>>(productCategories);
    ...
    //}
    #endregion end CreateProductCategories
