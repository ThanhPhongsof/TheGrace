...
using TheGrace.Contract.Services;

namespace TheGrace.Contract.Utils;
public static class SortOrderExtension
{
    ...
    public static IDictionary<string, SortOrder> ConvertStringToSortOrderV2ToProduct(string? sortOrder)
    {
